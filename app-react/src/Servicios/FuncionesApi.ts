...
export async function getDatosBar(){
	const urlServer = 'http://localhost:9000/api/v1/Instrumentos/DataBar';
	const response = await fetch(urlServer, {
		method: 'GET',
        headers: {
			'Content-type': 'application/json',
...
export async function getDatosPie() {
    const urlServer = 'http://localhost:9000/api/v1/Instrumentos/DataPie';
    const response = await fetch(urlServer, {
        method: 'GET',
        headers: {
            'Content-type': 'application/json',
...
export const downloadExcel = async (fechaInicio: Date, fechaFin: Date) => {
    try {
        const response = await fetch(`http://localhost:9000/excel/export?fechaInicio=${fechaInicio}&fechaFin=${fechaFin}`, {
            method: 'GET',
            headers: {
